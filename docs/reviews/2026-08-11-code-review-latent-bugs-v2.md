...
- **BUG-52:** `agents/manager.ts:406,149-156` — agents marked unavailable on one failure, cleared only per-run; one transient rate-limit pins the run to fallback agents.
