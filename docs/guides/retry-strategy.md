...
> Moved out of `.nax/rules/retry-strategy.md` so the rule carries prohibitions and this
> carries the API surface. SSOT for the code: `src/agents/retry/`. Introduced in #856.
> The rule is the authority on what is forbidden; this document explains how the
> sanctioned mechanisms work.
