...
Generated: 2026-03-10T09:54:15.959Z
...
- **test/integration/execution/runner-batching.test.ts**
  - Coverage: 33%
  - Missing: groupStoriesIntoBatches, precomputeBatchPlan
...
- test/integration/cli/cli-agents.test.ts
- test/integration/cli/cli-run-headless.test.ts
- test/integration/cli/cli-generate.test.ts
- test/integration/cli/precheck.test.ts
- test/integration/cli/agent-validation.test.ts
- test/integration/cli/precheck-orchestrator.test.ts
- test/integration/cli/cli-config-diff.test.ts
- test/integration/cli/cli-config-context-explain.test.ts
- test/integration/cli/cli-config-default-edge-cases.test.ts
- test/integration/cli/cli-logs.test.ts
- test/integration/cli/cli-config-agents-explain.test.ts
...
- test/integration/cli/precheck-integration.test.ts
