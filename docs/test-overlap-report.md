...
Generated: 2026-05-21T07:53:00.254Z
...
- **test/integration/pipeline/pipeline-acceptance.test.ts**
  - Coverage: 38%
  - Missing: acceptanceStage.enabled, acceptanceStage.execute, broken, BUG-083: acceptance command scoping, test-feature, test-feature, test-feature, test-feature
...
Found 108 unique integration test(s) with no unit test coverage:
...
- test/integration/review/prior-iterations-survive-rectify.test.ts
...
- test/integration/cli/cli-core-diagnose-ac5.test.ts
- test/integration/cli/cli-core-agents.test.ts
- test/integration/cli/cli-core-diagnose-ac3.test.ts
...
- test/integration/cli/cli-core-diagnose.test.ts
...
- test/integration/autofix/cycle-shadow.test.ts
- test/integration/autofix/fresh-failure-propagation.test.ts
