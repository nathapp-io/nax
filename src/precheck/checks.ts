 ...
 *
 * Individual check implementations for Tier 1 blockers and Tier 2 warnings.
 */
...
/**
 * Check if dependencies are installed (language-aware).
...
/**
 * Check if typecheck command works.
 * Skips silently if command is null/false.
 */
