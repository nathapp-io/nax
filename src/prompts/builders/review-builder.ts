...
- Every "error" finding MUST include \`acIndex\` (1-based, into the Acceptance Criteria above).
- \`acQuote\` is optional advisory text describing which part of the AC bullet you are enforcing — not validated.
- If no AC specifically constrains your finding, downgrade to \`"info"\`. Convention/coding-standard violations that no AC names belong as \`"info"\`.
  ...
  "findings": [
    {
      ...
      "acQuote": "<optional: AC bullet text you believe constrains this finding — advisory only>",
      "acIndex": 3,
      "verifiedBy": {
