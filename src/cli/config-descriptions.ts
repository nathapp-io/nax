...
export const FIELD_DESCRIPTIONS: Record<string, string> = {
  ...
  "agent.usageAudit.dir":
    "Directory to write usage audit files into. Absolute path, or used as-is — a relative path resolves against the process working directory, not workdir (default: <outputDir>/usage, i.e. ~/.nax/<project>/usage unless outputDir overrides it)",
