 ...
 * model, timeout, unavailable), so P5's classifier can select the human-labelled
 * ground-truth rows -- from the actual decision-maker, on the real distribution
 * -- out of the same file. P5's design records that such a corpus does not
 * exist; writing it now means P5 starts with labels rather than bootstrapping
 * them.
 *
