...
// ===========================================================================
// US-003 — rectification no-dispatch (absorbed from
// story-orchestrator-rectification-no-dispatch.test.ts)
// ===========================================================================
...
const ndTestSel = pickSelector("test-rect-no-dispatch-sel", "execution");
type TestSelConfig = ReturnType<typeof ndTestSel.select>;
