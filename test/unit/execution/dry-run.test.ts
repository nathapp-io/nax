/**
 * Dry-run behavior — nax#1808 / nax#1809.
 *
 ...
 *
 * #1808 stopped the PRD persistence and auto-commit, but three lifecycle
 * boundaries still performed real work or wrote tracked files under a dry run:
